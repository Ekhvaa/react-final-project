...
namespace TourApi.Migrations
{
    ...
    [Migration("20260709103000_AddProductionFeatures")]
    public partial class AddProductionFeatures : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_EmailConfirmationTokens_User_UserId",
                        column: x => x.UserId,
                        principalTable: "User",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Tours_CreatedByEmployeeId",
                table: "Tours",
                column: "CreatedByEmployeeId");

            migrationBuilder.CreateIndex(
                name: "IX_Tours_AssignedTourGuideId",
                table: "Tours",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Tours_Employees_CreatedByEmployeeId",
                table: "Tours",
                column: "CreatedByEmployeeId",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Tours_Employees_AssignedTourGuideId",
                table: "Tours",
                column: "AssignedTourGuideId",
                principalTable: "Employees",
                principalColumn: "Id");
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropTable(name: "TourImages");
            ...
            migrationBuilder.DropColumn(name: "CreatedByEmployeeId", table: "Tours");
            migrationBuilder.DropColumn(name: "AssignedTourGuideId", table: "Tours");
            migrationBuilder.DropColumn(name: "EmailConfirmed", table: "User");
        }
    }
}
